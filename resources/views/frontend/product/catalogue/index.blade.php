...
<div id="prd-catalogue" class="page-body">
    <x-breadcrumb :breadcrumb="$breadcrumb" />
     <div class="uk-container uk-container-center uk-container-1620">
     				...
     				<div class="sidebar-filter uk-panel">
                        ...
                        <div class="filter-block filter-search uk-margin-bottom">
                            ...
                            <div class="uk-form-icon">
                                ...
                                <input type="text" class="uk-form-small uk-width-1-1" placeholder="Nhập tên rượu vang...">
                            </div>
                        </div>
                        <div class="filter-section">
                            ...
                            <ul class="uk-nav filter-list">
                                <li>
                                    <label>
                                        <input type="checkbox" class="filter-price filtering"
                                            data-min="1000000" data-max="2000000">
                                        Từ 1 triệu - 2 triệu
                                    </label>
                                </li>
                                <li>
                                    <label>
                                        <input type="checkbox" class="filter-price filtering"
                                            data-min="2000000" data-max="3000000">
                                        Từ 2 triệu - 3 triệu
                                    </label>
                                </li>
                                <li>
                                    <label>
                                        <input type="checkbox" class="filter-price filtering"
                                            data-min="3000000" data-max="5000000">
                                        Từ 3 triệu - 5 triệu
                                    </label>
                                </li>
                                ...
                                <li>
                                    <label>
                                        <input type="checkbox" class="filter-price filtering"
                                            data-min="5000000" data-max="7000000">
                                        Từ 5 triệu - 7 triệu
                                    </label>
                                </li>
                                ...
                                <li>
                                    <label>
                                        <input type="checkbox" class="filter-price filtering"
                                            data-min="7000000" data-max="10000000">
                                        Từ 7 triệu - 10 triệu
                                    </label>
                                </li>
                                ...
                                <li>
                                    <label>
                                        <input type="checkbox" class="filter-price filtering"
                                            data-min="10000000" data-max="15000000">
                                ...
                                <li>
                                    <label>
                                        <input type="checkbox" class="filter-price filtering"
                                            data-min="15000000" data-max="20000000">
                                ...
                                <li>
                                    <label>
                                        <input type="checkbox" class="filter-price filtering"
                                            data-min="20000000" data-max="999999999">
                                        Trên 20 triệu
                                    </label>
                                </li>
                            </ul>
                            ...
                            <h3 class="filter-heading">{{ $catName }}</h3>
                                ...
                                <ul class="uk-nav filter-list">
                                    ...
                                    @endphp
                                    <li><label><input value="{{ $id }}" class="filtering filterAttribute" data-group="{{ $catId }}" type="checkbox"> {{ $name }} <span class="count">({{ $count }})</span></label></li>
                                    @endforeach
                                </ul>
                                @endif
                            @endforeach
                                    ...
                                    <li class="mb10">
                                        <div class="product-item">
                                            ...
                                            <div class="info">
                                                ...
                                                <h3 class="title"><a href="{{ $canonical }}" title="{{ $title }}">{{ $title }}</a></h3>
                                                <div class="price">
                                                    {!! $price['html'] !!}
                                                </div>
                                            </div>
