                        ...
                        <div class="swiper-wrapper big-pic">
                            <?php foreach($list_image as $key => $val){  ?>
                                <div class="swiper-slide" data-swiper-autoplay="2000">
                                    <a href="{{ $val }}" data-fancybox="my-group" class="image img-cover img-v">
          ...
          <div class="product-price">
                            ...
                            >
                                <span class="icon">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <path d="M1 1h4l2.8 13.4c.2 1 1 1.6 2 1.6h9.6c1 0 1.8-.7 2-1.6L23 6H6"></path>
                                    </svg>
                                </span>
            ...
            <div class="wine-detail-box">
                ...
                <div class="wine-detail-grid">
                    ...
                    <div class="item">
                        <span class="label uk-flex uk-flex-middle">
                            <img src="{{ asset('frontend/resources/img/pa_nha-san-xuat.svg') }}" alt="icon">
                            <span>Xuất Xứ:</span>
                        </span>
                    ...
                    <div class="item">
                        <span class="label uk-flex uk-flex-middle">
                            <svg class="mr10" width="25" height="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3 7L12 3L21 7V17L12 21L3 17V7Z" stroke="#9B0D1F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M3 7L12 11L21 7" stroke="#9B0D1F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M12 11V21" stroke="#9B0D1F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
